...
function GetListDept(months) {
    ...
    html += '</table> ';
    var locat = origin + "/Home/GetListDeptByDate/" + getMount + '/' + $('#sesionCompany').val();
    // alert(locat);
    $.ajax({
        type: "GET",
        url: locat,
        ...
        success: function (res) {
            ...
            new RGraph.Bar({
                ...
                options: {
                    ...
                    tooltipsFormattedKeyColors: ['#4f98c2', '#02F6F7', '#f7464a'],
