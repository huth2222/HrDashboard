function ListCus_site(getDate, getCompany, getZone) {
    // alert(getdate);
    // alert();
    $(document).ready(function () {
        ...
        var locat = origin + "/Manpower/GetManListCusSiteByDate/" + getDate + '/' + getCompany + '/' + getZone;
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                for (let index = 0; index < res.length; index++) {
                    ...
                    dataSetLabels.push(element.company_Code);

                }
                // alert(dataSetTarget);
                /******************************************* */

                Highcharts.chart('listSite', {
