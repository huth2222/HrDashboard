function ContractShiftB(getDate) {

    var locat = origin + "/Manpower/GetManContractSiteByDept/" + $('#sesionCompany').val() + "/" + getDate + '/' + "Car/2";
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            Highcharts.chart('ContractShiftB', {
                chart: {
                    backgroundColor: {
    ...
    stops: [
        ...
        [1, '#272727'] // end
                ...
                title: {
                    text: 'Headcount Classify by Contract-B shift',
                    style: {
                        fontSize: 14,
                        fontWeight: 'bold',
                        color: '#fff'
