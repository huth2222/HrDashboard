function DeptCarShiftB(getDate) {
    ...
    var locat = origin + "/Manpower/GetManDeptSiteByDept/" + $('#sesionCompany').val() + "/" + getDate + '/' + "Car/2";
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            Highcharts.chart('DeptCarShiftB', {
                
                chart: {
                    backgroundColor: Highcharts.defaultOptions.legend.backgroundColor || '#ecfaff',
                    zoomType: 'xy'
                },
                title: false,
                title: {
                    text: 'Headcount-B shift',
                    style: {
                        fontSize: 14,
                        fontWeight:'bold'
                    }
