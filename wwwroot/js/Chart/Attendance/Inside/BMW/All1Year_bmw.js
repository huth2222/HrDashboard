function AllYear_bmw(getDate,getShift) {

    var locat = origin + "/Attendance/GetAllListMonthBmwByDate/" + getDate + '/' + getShift;
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            for (let index = 0; index < res.length; index++) {
                ...
                dataSetAbsence.push(element.absence);
                dataLabels.push(element.getmonth);
